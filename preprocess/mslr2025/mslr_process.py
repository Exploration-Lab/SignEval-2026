...
#         signer, sentence_id = video_id.split('_',1)
...
#     root = Path("/DATACSEShare/sanjeet/dattatreya/Pose86K-CSLR-Isharah/annotations_v2/isharah2000")
#     dataset_save_root = './datasets/mslr2025'
#     for setting in ['SI', 'US']:
#         base_path = root / setting
#         sign_dict = dict()
#         save_dict = dict()
#         for md in ['train', 'dev']:
#             uniq_sent = set()
#             signer_set = set()
#             sentence_set = set()
#             file_path = base_path / f"{md}.csv"
#             print(f"Reading: {file_path}")   # optional sanity check
#             split_info = info2dict(file_path)
#             #split_info = info2dict(f'{setting}_{md}_list.csv', md)
#             pdb.set_trace()
